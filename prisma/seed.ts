...
async function seed() {
  ...
  const cocaCola = await db.product.create({
    data: {
      ...
      price: 11.5,
      imgLink:
        'http://cdn.shopify.com/s/files/1/0269/8575/8790/products/Coca_cola_355ml_c3458b36-1bfd-4241-9834-5dec83b0378b.png?v=1618852366',
  ...
  const pepsi = await db.product.create({
    data: {
      ...
      price: 11.45,
      imgLink:
        'https://st3.depositphotos.com/8478842/18358/v/450/depositphotos_183583568-stock-illustration-pepsi-cola-coda-drinks.jpg',
      imgList: [
        'https://www.knjaznatura.co.rs/files/thumbs/files/files/thumbs_600/1300001542_600_600px.jpg',
      ],
    },
  })
  ...
  const iceTea = await db.product.create({
    data: {
      ...
      subCategory: 'tea',
      description:
        'Iced tea (or ice tea)[1] is a form of cold tea. Though it is usually served in a glass with ice, it can refer to any tea that has been chilled or cooled.',
      price: 11.0,
      imgLink:
        'https://ayb.akinoncdn.com/products/2022/04/12/3560/bfe7d2f6-d113-4e28-b1ce-8522e5023f82_size780x780_quality60_cropCenter.jpg',
      imgList: [
        'https://reimg-carrefour.mncdn.com/mnresize/600/600/productimage/30141743/30141743_0_MC/8809365700658_1600421577264.jpg',
      ],
    },
  })
  ...
  const water = await db.product.create({
    data: {
      ...
      imgLink:
        'https://objectstorage.ap-mumbai-1.oraclecloud.com/n/softlogicbicloud/b/cdn/o/products/600-600/119329--01--1635243305.jpeg',
      imgList: [
        'https://d10ui928gx5i4g.cloudfront.net/media/cache/03/e2/03e2f3b2f5c559475a77a4efb74e8db5.jpg',
      ],
    },
  })
  ...
  const chocolate = await db.product.create({
    data: {
      ...
      price: 7.45,
      imgLink:
        'https://cdn.shopify.com/s/files/1/0413/1107/6505/products/07040550-5608ae-1650x1650_1024x.jpg?v=1592850335',
      category: 'food',
      subCategory: 'chocolate',
      description:
        "Milka is one of the world's most beloved – and recognizable – chocolate brands. Made with Alpine milk, Milka has been delighting consumers in Germany and beyond since 1901. The brand, with its unique lilac-colored packaging and Lila, the Milka cow, have a dedicated “cow-munity” of adoring fans around the world!",
  ...
  const macbookAir = await db.product.create({
    data: {
      ...
      price: 1153.93,
      imgLink:
        'https://reimg-teknosa-cloud-prod.mncdn.com/mnresize/600/600/productimage/125036119/125036119_0_MC/48344531.jpg',
    ...
    `,
      imgList: [
        'https://reimg-teknosa-cloud-prod.mncdn.com/mnresize/600/600/productimage/125036119/125036119_1_MC/48412556.jpg',
        'https://reimg-teknosa-cloud-prod.mncdn.com/mnresize/600/600/productimage/125036119/125036119_2_MC/48412557.jpg',
        'https://reimg-teknosa-cloud-prod.mncdn.com/mnresize/600/600/productimage/125036119/125036119_3_MC/48344534.jpg',
        'https://reimg-teknosa-cloud-prod.mncdn.com/mnresize/600/600/productimage/125036119/125036119_4_MC/48344535.jpg',
        'https://reimg-teknosa-cloud-prod.mncdn.com/mnresize/600/600/productimage/125036119/125036119_5_MC/48412538.jpg',
      ],
    },
  })
  ...
  const macbookPro = await db.product.create({
    data: {
      ...
      price: 2546.5,
      imgLink:
        'https://reimg-teknosa-cloud-prod.mncdn.com/mnresize/600/600/productimage/125034259/125034259_0_MC/57261934.jpg',
      category: 'electronics',
      subCategory: 'computers',
      description: `
    About this item
    ...
    `,
      imgList: [
        'https://reimg-teknosa-cloud-prod.mncdn.com/mnresize/600/600/productimage/125034259/125034259_1_MC/57262048.jpg',
        'https://reimg-teknosa-cloud-prod.mncdn.com/mnresize/600/600/productimage/125034259/125034259_2_MC/57261999.jpg',
        'https://reimg-teknosa-cloud-prod.mncdn.com/mnresize/600/600/productimage/125034259/125034259_3_MC/57262328.jpg',
        'https://reimg-teknosa-cloud-prod.mncdn.com/mnresize/600/600/productimage/125034259/125034259_4_MC/57262354.jpg',
        'https://reimg-teknosa-cloud-prod.mncdn.com/mnresize/600/600/productimage/125034259/125034259_7_MC/57262440.jpg',
      ],
    },
  })
  ...
  const miFryer = await db.product.create({
    data: {
      ...
      price: 157.68,
      imgLink:
        'https://reimg-teknosa-cloud-prod.mncdn.com/mnresize/600/600/productimage/120412509/120412509_0_MC/56452563.png',
      category: 'electronics',
      subCategory: 'kitchen',
      ...
      imgList: [
        'https://www.birnumara.com/image/cache/data/resimler/xiaomi-mi-smart-air-fryer-3-5-lt-yagsiz-fritoz-49993-600x600.png',
        'https://reimg-carrefour.mncdn.com/mnresize/600/600/productimage/30385166/30385166_2_MC/8840401911858_1648538424305.jpg',
      ],
    },
  })
  ...
  const ps5 = await db.product.create({
    data: {
      ...
      price: 500.0,
      imgLink:
        'https://cdn.shopify.com/s/files/1/0397/7982/7863/products/PS5K6_600x.jpg?v=1624623949',
      category: 'electronics',
      subCategory: 'gaming',
      description: `About this item
      ...
      imgList: [
        'https://www.birnumara.com/image/cache/data/resimler/sony-playstation-5-oyun-konsolu-32402-600x600.jpg',
        'https://buynow.com.mt/image/cache/catalog/ps5dual-600x600.jpeg',
      ],
    },
  })
  ...
  const xboxSeriesS = await db.product.create({
    data: {
      ...
      price: 400.0,
      imgLink:
        'https://reimg-teknosa-cloud-prod.mncdn.com/mnresize/600/600/productimage/125088429/125088429_1_MC/48352428.jpg',
      category: 'electronics',
      subCategory: 'gaming',
      description: `About this item
      ...
      imgList: [
        'https://reimg-teknosa-cloud-prod.mncdn.com/mnresize/600/600/productimage/125088429/125088429_2_MC/48352427.jpg',
        'https://www.eros.ae/media/catalog/product/cache/4d25cc2d7db4bdfe410479ebb1f61f20/m/i/microsoft-xbox-series-s-console-white-2.jpg',
      ],
    },
  })
  ...
  const xboxSeriesX = await db.product.create({
    data: {
      ...
      price: 500.0,
      imgLink:
        'https://reimg-teknosa-cloud-prod.mncdn.com/mnresize/600/600/productimage/125088428/125088428_0_MC/48351660.jpg',
      category: 'electronics',
      subCategory: 'gaming',
      description: `About this item
      ...
      imgList: [
        'https://ultimateconnection.co.za/wp-content/uploads/2021/11/XBOX-SERIES-X-1TB-1.png',
      ],
    },
  })
  ...
  const galaxyS22Ultra = await db.product.create({
    data: {
      ...
      price: 1000.0,
      imgLink:
        'https://reimg-teknosa-cloud-prod.mncdn.com/mnresize/600/600/productimage/125078448/125078448_0_MC/62184198.jpg',
      category: 'electronics',
      subCategory: 'phone',
      description: `About this item
      ...
      imgList: [
        'https://reimg-teknosa-cloud-prod.mncdn.com/mnresize/600/600/productimage/125078456/125078456_0_MC/60699488.jpg',
        'https://reimg-teknosa-cloud-prod.mncdn.com/mnresize/600/600/productimage/125078450/125078450_0_MC/60699520.jpg',
      ],
    },
  })
}
